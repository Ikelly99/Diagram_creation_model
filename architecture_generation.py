...
with col1:
    ...
    with st.container():
        ...
        text_input = st.text_area("Enter the specifications")
...
with col2:
    ...
    if buttom_check and option == 'AWS' and text_input: 
        ...
        if analyze_prompt(text_input) == "Allowed" and cla==1:
            ...
            if allowed == "allowed":
                arch_requisites, python_diagram_runnable, explanation, service_connections,\
                image_file_name = LLM_Diagram(text_input).diagram_first_answer()
        ...
        if analyze_prompt(text_input) == "Allowed" and cla==1:
            ...
            if allowed == "allowed":
                ...
                text_out = " Your message was flagged as malicious"
        else:
            text_out = "Your message was flagged as malicious"
        ...
        st.write("Enter the specifications to get started")
        
txt = st.text_area(text_out)