...
from perceptron import perceptron, vectorizer


"""" this doc was used to trained the perceptron model. used to classify prompts as malicious or non malicious"""
...
prompts_2 = pd.read_csv(r"/prompt_db.csv").iloc[:, 1:]
